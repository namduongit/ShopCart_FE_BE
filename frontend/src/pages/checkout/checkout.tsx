...
const CheckoutPage = () => {
  ...
  const { query: queryCoupon, loading: couponLoading } =
    useExecute<CouponDto>();
  ...
  if (!authContext?.isAuthenticated) {
    return (
      ...
      >
        ...
        />
        <h2
          style={{ fontSize: 20, fontWeight: 700, color: "#374151", margin: 0 }}
        >
          Chưa đăng nhập
        </h2>
        <Link
  ...
  const handleApplyCoupon = async () => {
    ...
    setCoupon(null);
    await queryCoupon(
      () => CouponService.CheckCoupon(form.couponCode.trim(), subtotal),
      {
        onSuccess(data) {
          if (data) {
            setCoupon(data);
            notificationContext?.showToast({
              ...
              message: `Mã "${data.name}" giảm ${fmtPrice(data.value)}`,
            });
          }
        },
        onError() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (form.couponCode.trim() && !coupon) {
      notificationContext?.showToast({
        ...
        message: 'Vui lòng nhấn "Áp dụng" hoặc xóa mã trước khi đặt hàng.',
      });
      return;
    }
    ...
    await queryCheckstock(
      () => InventoryService.CheckStock(checkStockRequest),
      {
        issueNetwork: true,
        onSuccess(data) {
          stockOk = data ?? false;
    ...
    if (createdOrderId !== undefined) {
      ...
      notificationContext?.showToast({
        ...
        message: `Đơn hàng #${createdOrderId} đã được tạo!`,
      });
  ...
  return (
    <div
      style={{ background: "#f9fafb", minHeight: "100vh", padding: "32px 0" }}
    ...
    >
      <div className="container-main">
        ...
        >
          ...
          <Link to="/page/cart" style={{ color: "#2563eb" }}>
            Giỏ hàng
          </Link>
          <i className="fa-solid fa-chevron-right" style={{ fontSize: 9 }} />
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            >
              ...
              >
                <i className="fa-solid fa-truck" style={{ color: "#2563eb" }} />{" "}
                Thông tin giao hàng
              </h3>
              <SForm onSubmit={handleSubmit} style={{ gap: "16px" }}>
                ...
                <SInput
                  ...
                  options={{
                    ...
                    prefix: <i className="fa-solid fa-location-dot" />,
                  }}
                />
                    ...
                    {PAYMENT_METHODS.map((m) => (
                      <label
                        ...
                        style={{
                          ...
                          background:
                            form.paymentMethod === m.value ? "#eff6ff" : "#fff",
                      ...
                      >
                        <input
                          ...
                          onChange={() =>
                            setForm((f) => ({ ...f, paymentMethod: m.value }))
                          }
                          style={{
                            accentColor: "#2563eb",
                            width: 16,
                ...
                <div>
                  ...
                  {coupon ? (
                    ...
                    >
                      ...
                      >
                        {coupon.name} — Giảm {fmtPrice(coupon.value)}
                      </span>
                      <button
                        type="button"
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                      <div style={{ flex: 1, position: "relative" }}>
                        ...
                        <input
                          ...
                          style={{
                            ...
                            border: `1.5px solid ${couponError ? "#f87171" : "#e5e7eb"}`,
                            borderRadius: 8,
                            fontSize: 14,
                            fontFamily: "inherit",
                            color: "#111827",
                      ...
                      <button
                        ...
                        style={{
                          ...
                          fontSize: 13,
                          cursor:
                            couponLoading || !form.couponCode.trim()
                              ? "not-allowed"
                              : "pointer",
                          fontFamily: "inherit",
                          whiteSpace: "nowrap",
                          opacity: !form.couponCode.trim() ? 0.5 : 1,
                        }}
                      >
                        {couponLoading ? (
            ...
            >
              ...
              {shippingFee > 0 && (
                ...
                >
                  ...
                  />
                  Mua thêm{" "}
                  <strong style={{ color: "#b45309", margin: "0 3px" }}>
                    {fmtPrice(FREE_SHIPPING_THRESHOLD - subtotal)}
                  </strong>{" "}
