...
const CheckoutPage = () => {
    ...
    if (!authContext?.isAuthenticated) {
        return (
            <div style={{ minHeight: "60vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16, padding: "40px 20px" }}>
                ...
                <Link to="/page/login" style={{ padding: "10px 24px", borderRadius: 8, background: "#2563eb", color: "white", fontWeight: 600, fontSize: 14 }}>
                    Đăng nhập ngay
                </Link>
            </div>
        );
    ...
    if (cartItems.length === 0) {
        return (
            <div style={{ minHeight: "60vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16, padding: "40px 20px" }}>
                ...
                <Link to="/page/product" style={{ padding: "10px 24px", borderRadius: 8, background: "#2563eb", color: "white", fontWeight: 600, fontSize: 14 }}>
                    Tiếp tục mua sắm
                </Link>
            </div>
        );
    ...
    const handleApplyCoupon = async () => {
        ...
        setCoupon(null);
        await queryCoupon(
            () => CouponService.CheckCoupon(form.couponCode.trim()),
            {
                onSuccess(data) {
                    if (data) {
                        setCoupon(data);
                            ...
                            <SForm onSubmit={handleSubmit} style={{ gap: "16px" }}>
                                    ...
                                    {coupon ? (
                                        <div style={{
                                            ...
                                            <button type="button" onClick={handleRemoveCoupon} style={{
                                                ...
                                                color: "#dc2626", fontSize: 13, padding: 0
                                            }}>
                                        ...
                                        <div style={{ display: "flex", gap: 8 }}>
                                            ...
                                            <button
                                                ...
                                                style={{
                                                    padding: "10px 18px", borderRadius: 8, border: "1.5px solid #2563eb",
                                                    background: "#fff", color: "#2563eb", fontWeight: 600, fontSize: 13,
                                                    cursor: couponLoading || !form.couponCode.trim() ? "not-allowed" : "pointer",
                                                    fontFamily: "inherit", whiteSpace: "nowrap", opacity: !form.couponCode.trim() ? 0.5 : 1
                                                }}
                                            >
                                ...
                                <SButton
                                    ...
                                    loading={{
                                        ...
                                        loadingChildren: <><i className="fa-solid fa-circle-notch fa-spin" /> Đang đặt hàng...</>,
                                    }}
