...
<<<<<<< Updated upstream
      <div className="container-main" style={{ padding: "32px 20px" }}>
        <div
          className="skeleton"
          style={{ height: 16, width: 240, marginBottom: 28 }}
        />
        <div
        ...
        >
          <div>
            <div
              className="skeleton"
              style={{ paddingTop: "75%", borderRadius: 10 }}
            />
...
>>>>>>> Stashed changes
    ...
    return (
      ...
      >
        ...
        <p style={{ color: "#9ca3af", marginBottom: 24 }}>
          ID sản phẩm không hợp lệ hoặc đã bị xóa.
        </p>
        <Link
          to="/"
          style={{
  ...
  const allImages = [product.mainImageUrl, ...product.imageUrls].filter(
    Boolean,
  );
      ...
      >
        <div className="container-main" style={{ padding: "10px 20px" }}>
          ...
          >
            ...
            <i className="fa-solid fa-chevron-right" style={{ fontSize: 9 }} />
            <Link to="/page/product" style={{ color: "#2563eb" }}>
              Sản phẩm
            </Link>
            <i className="fa-solid fa-chevron-right" style={{ fontSize: 9 }} />
            <span
                ...
                {allImages.map((img, i) => (
                  <button
                    ...
                    style={{
                      ...
                      border: "2px solid",
                      borderColor:
                        selectedImg === img ? "#2563eb" : "var(--border)",
                      cursor: "pointer",
                      padding: 0,
                      background: "#f3f4f6",
                    }}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            <button
              ...
              style={{
                ...
                fontSize: 15,
                fontWeight: 700,
                cursor: isActive && !isBusy ? "pointer" : "not-allowed",
                fontFamily: "inherit",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
              ...
              onMouseEnter={(e) => {
                if (isActive && !isBusy && !added)
                  e.currentTarget.style.background = "#1d4ed8";
              }}
              onMouseLeave={(e) => {
                if (!added)
                  e.currentTarget.style.background =
                    isActive && !isBusy ? "#2563eb" : "#e5e7eb";
              }}
            >
              {isBusy ? (
                <>
                  <i className="fa-solid fa-circle-notch fa-spin" /> Đang
                  thêm...
                </>
              ) : added ? (
                <>
          ...
          >
            ...
            {tab === "description" && (
              <div>
                ...
                >
                  {product.description ||
                    `${product.name} là sản phẩm chính hãng với cấu hình mạnh mẽ, đáp ứng mọi nhu cầu.`}
                </p>
                <ul
                  style={{
                    marginTop: 14,
